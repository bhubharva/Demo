 ...
 * 
 * 
 * @modified	: 14-Jun-2013
 * @author		: Krishna Komarpant @Cybage 
 * @log			: Changed class name XMLParser to XMLParser2 at instantiation[Line:77] 
 * This class name was conflicting a pre-included XMLParser.php file in cpg/lib/interface/paymentgateway/centinel/CentinelClient.php. 
 * This file had the same CLASS NAME as lib/plugins/xmlprocessor/xmlparser.php CLASS NAME
 * Hence, Class name changed from XMLParser->XMLParser2 in xmlparser.php. Old file:xmlparser.php->New file: xmlparser2.php
 */
class XmlParser2 {
	 ...
	 */
	public function XmlParser2($input) {
